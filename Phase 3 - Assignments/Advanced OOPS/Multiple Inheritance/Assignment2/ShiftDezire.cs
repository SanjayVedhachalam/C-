...
namespace Assignment2
{
    public class ShiftDezire : Car, IBrand
    {
        ...
        public ShiftDezire(string fuelType,int numberOfSeats,string color,double tankCapacity,double numberOfKmDriven,string brandName,string modelName,string engineNumber,string chasisNumber){
            ++s_makingID;
            MakingID="SHIFT-MID"+s_makingID;
            FuelType=fuelType;
